...
export default function DoorOpeningSlides() {
  ...
  return (
    <div ref={sectionRef} className="w-full h-screen overflow-hidden bg-white">
      <div className="relative w-full h-full flex items-center justify-center">
          ...
          <div className="w-full aspect-square overflow-hidden bg-gray-800">
            ...
            <div className="absolute inset-0 flex flex-col justify-between z-30 pointer-events-none p-4">
              <div className="flex justify-between mt-8">
                <h3 className="text-white text-xs md:text-sm tracking-wider" style={{ fontFamily: "'Cormorant Garamond', serif" }}>DESIGN</h3>
                <h3 className="text-white text-xs md:text-sm tracking-wider" style={{ fontFamily: "'Cormorant Garamond', serif" }}>BY Mr Duong</h3>
      </div>

              <div className="flex justify-between">
                <h3 className="text-white text-xs md:text-sm tracking-wider" style={{ fontFamily: "'Cormorant Garamond', serif" }}>3D VISUALIZATION</h3>
                <h3 className="text-white text-xs md:text-sm tracking-wider" style={{ fontFamily: "'Cormorant Garamond', serif" }}>BY IDA Lighting team</h3>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Scroll indicator */}
        {hasViewedAllSlides && (
          <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-black/50 text-sm animate-bounce">
            Scroll to continue
          </div>
          )}
        </div>
