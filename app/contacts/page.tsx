            ...
            <div className="w-full md:w-1/2">
              ...
              >
                ...
                <div className="flex flex-col items-center">
                  <div className="relative w-64 h-64 p-4 border-2 border-gray-700 bg-white/10 backdrop-blur-sm rounded-xl mb-6">
                    <img 
                      src="/qr-zalo.png" 
                      alt="Zalo QR Code" 
                      className="w-full h-full object-contain"
                    />
                    <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 bg-black/40 px-4 py-1 rounded-full border border-gray-700">
                      <span className="font-medium text-blue-400">Zalo</span>
                    </div>
                  </div>
                  
                  <div className="text-center mb-6">
                    <p className="text-white font-medium mb-2">Lợi ích khi kết nối qua Zalo:</p>
